...
class User(UserMixin, db.Model):
    ...
    last_quiz_date = db.Column(db.Date, nullable=True, default=None)
...
class Question(db.Model):
    ...
    created_at = db.Column(db.DateTime, default=datetime.utcnow)
    attempts = db.relationship('UserProgress', backref='question', lazy='dynamic', cascade='all, delete-orphan')
